  ...
  return (
    <div>
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald/10 text-emerald text-[10px] font-medium uppercase tracking-widest mb-4">
          <Sparkles className="w-3 h-3" />
          Indie Dev
        </div>
        <h1 className="text-3xl font-bold emerald-shimmer mb-3 mx-auto w-fit">Apps I Build</h1>
        ...
        {apps.map((app) => {
          ...
          return (
            <a
              ...
              className="block bg-surface rounded-2xl border border-border hover:border-emerald/20 transition-all duration-300 overflow-hidden"
            >
              <div className="p-5">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0 bg-emerald/10">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {app.tags.slice(0, 3).map((tag) => (
                          <span
                            key={tag}
                            className="text-[10px] px-1.5 py-0.5 rounded-full bg-emerald/10 text-muted"
                          >
                            {tag}
                          </span>
                        ))}
                ...
                <div className="inline-flex items-center gap-1.5 mt-4 text-xs font-medium text-emerald">
                  Open App
      ...
      <div className="text-center mt-8 mb-4">
        <a
          href="https://franciscocucullu.com/apps/"
          target="_blank"
          className="text-[11px] text-muted/60 hover:text-emerald transition-colors"
        >
