...
const DISMISS_KEY = "listly_install_dismissed";
  ...
  return (
    <div className="bg-surface rounded-2xl border border-border p-4 flex items-start gap-3">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold mb-0.5">Install Listly</p>
        {showIOSGuide ? (
          iosExpanded ? (
            <div className="space-y-3 mt-1">
              <div className="flex items-start gap-2">
                <span className="bg-emerald text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">1</span>
              ...
              <div className="flex items-start gap-2">
                <span className="bg-emerald text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">2</span>
                <p className="text-xs text-muted">Scroll down and tap <span className="font-medium text-foreground">&quot;Add to Home Screen&quot;</span></p>
              </div>
              <div className="flex items-start gap-2">
                <span className="bg-emerald text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5">3</span>
                <p className="text-xs text-muted">Tap <span className="font-medium text-foreground">&quot;Add&quot;</span> to confirm</p>
              </div>
              <p className="text-[10px] text-muted">Listly will appear on your home screen like a regular app!</p>
            </div>
          ) : (
            <>
              ...
              <button
                ...
                className="bg-emerald text-white text-xs font-medium px-4 py-1.5 rounded-lg hover:bg-emerald/80 transition-colors"
              >
                Show me how
              </button>
            </>
